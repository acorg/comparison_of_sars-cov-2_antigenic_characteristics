...
excluded_comp_ags <- c('A.23.1', 'B.1.525')
...
saveRDS(
  ...
  file = 'data/individual_datasets/emory/outliers/outliers.rds'
)
...
save.acmap(map_full_no_outliers, 'data/individual_datasets/emory/maps/map-no-outliers.ace')
