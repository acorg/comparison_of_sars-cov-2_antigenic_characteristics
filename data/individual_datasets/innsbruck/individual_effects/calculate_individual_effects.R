...
# Read in the map
map_full_no_outliers <- read.acmap('data/individual_datasets/innsbruck/maps/map-OmicronI+II+III-thresholded-single_exposure-P1m1-no-nds-no-outliers.ace')
...
for (sr_group in levels(srGroups(map_full_no_outliers))) {
...
saveRDS(individual_effects, file = 'data/individual_datasets/innsbruck/individual_effects/individual_effects.rds')
saveRDS(ag_means_individual_effects, file = 'data/individual_datasets/innsbruck/individual_effects/ag_gmt_individual_effects.rds')
