...
titers <- read.titerTable('data/individual_datasets/wustl/rawdata/129-table-025.csv')
sr_groups_info <- read.csv('data/individual_datasets/wustl/rawdata/sr_groups.csv', stringsAsFactors = FALSE)
...
map_subset <- translateMap(map_subset, c(0, 0.3))

# Name the map
mapName(map_subset) <- 'st_louis'

# Save the map
save.acmap(map_subset, 'data/individual_datasets/wustl/maps/map.ace')
