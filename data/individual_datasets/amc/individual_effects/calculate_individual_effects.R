...
# Read in the map
map_full_no_outliers <- read.acmap('data/individual_datasets/amc/maps/map_no_outliers.ace')
...
saveRDS(individual_effects, file = 'data/individual_datasets/amc/individual_effects/individual_effects.rds')
saveRDS(ag_means_individual_effects, file = 'data/individual_datasets/amc/individual_effects/ag_gmt_individual_effects.rds')
