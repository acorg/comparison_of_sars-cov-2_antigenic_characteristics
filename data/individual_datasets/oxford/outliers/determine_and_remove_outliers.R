...
saveRDS(
  ...
  file = 'data/individual_datasets/oxford/outliers/outliers.rds'
)
...
save.acmap(map_full_no_outliers, 'data/individual_datasets/oxford/maps/map_no_outliers.ace')
