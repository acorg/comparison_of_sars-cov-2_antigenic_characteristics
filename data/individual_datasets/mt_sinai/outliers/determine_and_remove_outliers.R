...
saveRDS(
  ...
  file = 'data/individual_datasets/mt_sinai/outliers/outliers.rds'
)
...
save.acmap(map_full_no_outliers, 'data/individual_datasets/mt_sinai/maps/map_no_outliers.ace')
