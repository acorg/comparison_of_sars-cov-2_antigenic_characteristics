...
# Cross validation performed excluding 10% of titers, then predicting them, 100 cross-validation replicates
...
results <- crossvalidateMap(map, number_of_optimizations = 1000, number_of_replicates = 100, test_proportion = 0.1)
...
saveRDS(results, 'data/merged_map/cross_validation/cross_validation_result.rds')
