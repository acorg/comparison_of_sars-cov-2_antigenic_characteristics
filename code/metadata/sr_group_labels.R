...
sr_group_labels_no_sera <- c(
  ...
  'mRNA-1273'              = 'mRNA-1273 vaccinated',
  'B.1.351 convalescent'   = 'B.1.351 convalescent',
  'B.1.617.2 convalescent' = 'B.1.617.2 convalescent',
  'WT convalescent'        = 'D614G convalescent',
  'B.1.1.7 convalescent'   = 'B.1.1.7 convalescent',
  'P.1 convalescent'       = 'P.1 convalescent',
  'BA.1 convalescent'      = 'BA.1 convalescent',
  'BA.2 convalescent'      = 'BA.2 convalescent',
  'AstraZeneca'            = 'AZD1222 vaccinated',
  'Pfizer'                 = 'BNT162b2 vaccinated',
  'D614G convalescent'     = 'D614G convalescent',
  'AstraZeneca-Pfizer'     = 'AZD1222-BNT162b2 vaccinated',
  'B.1.429 convalescent'   = 'B.1.429 convalescent',
  'C.37 convalescent'      = 'C.37 convalescent',
  'B.1.526+E484K convalescent' = 'B.1.526+E484K convalescent'
)
...
sr_group_labels <- paste(sr_group_labels_no_sera, 'serum')
