...
ag_means_individual_effects <- readRDS('data/individual_datasets/amc/individual_effects/ag_gmt_individual_effects.rds')
sr_group_gmts <- ag_means_individual_effects %>% rename(logtiter = ag_gmt_accounting_for_individual_effect)

# Read in outlier data
outliers <- readRDS('data/individual_datasets/amc/outliers/outliers.rds')
...
ggsave('som_figures/fig_s13_amc_outliers/fig_s13_amc_outliers.png', plot = gpx, width = 9, height = 8)
ggsave('som_figures/fig_s13_amc_outliers/fig_s13_amc_outliers.pdf', plot = gpx, width = 9, height = 8)
